      ...
      <div class="parent">
        <div class="div1">
          ...
          <p className="subsidesSubText">
            ITA Point of Sale is a web based point
            of sale system. The main features are:
          </p>
          <ul>
            <li>
            ...
            <li>
              VAT, customer and multi tiers
              taxation
            </li>
            <li>
              Sale register with transactions
              logging
            </li>
            <li>Quotation and invoicing</li>
            <li>Expenses logging</li>
            <li>
              Receipt and invoice printing and/or
              emailing
            </li>
            <li>
            ...
            <li>Multilanguage</li>
            <li>
              Selectable Boostrap (Bootswatch)
              based UI theme
            </li>
            <li>Mailchimp integration</li>
            <li>
              reCAPTCHA to protect login page from
              brute force attacks
            </li>
            <li>GDPR ready</li>
            <li>Manage Customer/Vendor</li>
            <li>Customer Group</li>
            <li>Create Sales / Purchase</li>
            <li>Return Sales and Purchase</li>
            <li>Received Purchase Products</li>
            <li>Product Bar-Code Generate</li>
            <li>Manage Employee</li>
            <li>Products and Services</li>
            <li>Inventory Products</li>
            <li>Non Inventory Products</li>
